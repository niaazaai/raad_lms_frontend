...
/** Keeps form controls readable on the light card when the app theme is dark (don’t change the page background). */
    ...
    return (
      <div className="min-h-screen bg-layout-body flex flex-col">
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center px-4 py-10">
          <section
            className={cn(
              "w-full max-w-md rounded-xl border border-border/60 bg-white/95 p-6 shadow-lg md:p-8",
              authFormLightScope
            )}
          >
            <LoginWith2FA />
        ...
        >
          <div className="mb-2">
            ...
            <div className="mb-6 space-y-1 text-center">
              ...
              <p className="text-sm text-muted-foreground">Sign in to continue to Raad LMS</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <label className="flex cursor-pointer items-center gap-2">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border border-input bg-white text-primary accent-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
                    {...register("remember")}
                  />
